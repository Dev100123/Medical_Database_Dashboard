...
def show_esami_specialistici_dashboard(df):
    """Specialized dashboard for 'Esami Specialistici' dataset with enhanced visualizations"""
    st.title("📈 Esami Specialistici Analytics Dashboard")
